...
"""
# Primera lista de verbos:
verbos_aleman = ["zergehen ", "unterkriegen", "wühlen", "einfallen", "zeugen", "beitragen", "ausrufen", "verlieren", "bedrohen", "versprechen", "umdenken", "ernähren", "betteln","betreffen", "wirken", "öffnen", "vorschlagen", "nachdenken", "wachsen", "anschauen", "auskommen", "rühren", "achten", "begründen", "aufkommen", "aussehen", "anfangen", "erklären", "berichten"]
